    ...
    <>
      <Card style={styles.container}>
        <Card.Content>
          ...
          <Text style={styles.subTitle}>Your Root Causes <Text style={{ color: 'lightgray' }}>___________________</Text></Text>
          <View style={styles.causesRow}>
            <TouchableOpacity style={styles.causeItem} onPress={handleOnClick}>
